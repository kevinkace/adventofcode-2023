...
import { getNums, parseNums, swapMatchesAllRows, getMatches, swapLowestMatch, swapAllMatches, sumFromRows } from "../../01";
...
describe("day 01", () => {
    ...
    test("can num swap", () => {
        expect(swapMatchesAllRows("one")).toBe("1");
        expect(swapMatchesAllRows("oneone")).toBe("11");
        expect(swapMatchesAllRows("one1one\ntwo")).toBe("111\n2");
    ...
    test.only("non-swapping", () => {
        [{
            ...
            const result = sumFromRows(_input);
